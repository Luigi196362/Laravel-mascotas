...
<div class="añadir_icono">
    <a href="{{ route('citas.create') }}"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
        ...
        <table class="table table-striped">
            ...
            @foreach($citas as $cita) 
                <tr>
                    ...
                    <td><img src="{{ $cita ->mascota ->imagen ?? 'N/A'}}" alt="imagen" style="width: 100px;"> </td>
                    ...
                    <td>
                        <form action="{{ route('citas.edit') }}" method="POST">
                                @csrf
